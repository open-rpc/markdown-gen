---
title: "Block"
description: "Schema definition for Block."
sidebar_label: "Block"
schema_name: "Block"
tags:
  - json-rpc
...
| sha3Uncles | `string` | yes |  |
| miner | `string` | yes |  |
| stateRoot | `string` | yes |  |
| transactionsRoot | `string` | yes |  |
...
| mixHash | `string` | yes |  |
| nonce | `string` | yes |  |
| baseFeePerGas | `string` | no |  |
| withdrawalsRoot | `string` | no |  |
| blobGasUsed | `string` | no |  |
| excessBlobGas | `string` | no |  |
| parentBeaconBlockRoot | `string` | no |  |
| size | `string` | yes |  |
| transactions | `anyOf` | yes |  |
| withdrawals | `object[]` | no |  |
| uncles | `string[]` | yes |  |
