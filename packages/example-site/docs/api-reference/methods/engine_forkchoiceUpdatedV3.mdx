...
description: "Documentation for JSON-RPC method engine_forkchoiceUpdatedV3."
sidebar_label: "engine_forkchoiceUpdatedV3"
...
- **JSON-RPC method name:** `engine_forkchoiceUpdatedV3`
